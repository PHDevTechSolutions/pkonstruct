      ...
      <div className="container mx-auto relative z-20 px-4 py-24 md:py-32 lg:py-40">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button size="lg" variant="outline" asChild className="border-foreground text-foreground hover:bg-foreground hover:text-background">
              <Link href="#contact">
          ...
          <div className="grid grid-cols-3 gap-8 mt-12 pt-12 border-t border-foreground/20">
            <div>
