...
const GlobeIcon = () => (
  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" strokeWidth="2"/><path strokeWidth="2" d="M2 12h20"/><path strokeWidth="2" d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/></svg>
)
...
export function SocialLinksWidget({ section }: SocialLinksWidgetProps) {
  ...
  try {
    ...
    // Content might be { links: [...] } or just [...]
    links = parsedContent?.links || parsedContent || []
    ...
    links = [
      ...
      { id: "4", platform: "twitter", url: "#", label: "Twitter" },
      { id: "5", platform: "youtube", url: "#", label: "YouTube" }
    ]
  }
